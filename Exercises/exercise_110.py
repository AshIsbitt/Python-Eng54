...
ratings = {"U":"Everyone can watch",
           "PG":"May be unsuitable for younger children",
           "12":"May not generally suitable for children aged under 12. No one younger than 12 may see a 12A film in a "
...
while True:
    print(ratings.keys())
    rate = input("Enter a film rating, or E to exit: ")
    ...
    try:
        rate = int(rate)
        print(ratings[str(rate)])
    except ValueError:
        print(ratings[rate.upper()])